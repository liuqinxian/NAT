...
class dpn(nn.Module):
    def __init__(self, cfg):
        ...
        self.linear = nn.Linear(out_planes[3]+(num_blocks[3]+1)*dense_depth[3], 1)#10)
    ...
    def forward(self, x):
        ...
        out = F.relu(self.bn1(self.conv1(x)))   # [1, 64, 32, 32 ,32]
        ...
        out_1 = out.view(out.size(0), -1)       # feature
        if debug: print ('7', out_1.size())
        out = self.sigmoid(self.linear(out_1))
